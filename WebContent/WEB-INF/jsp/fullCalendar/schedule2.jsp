...
<html>
	...
	<body>
			                    ...
			                    <div class="modal-body">
			                        ...
			                        <div class="row">
			                            <div class="col-xs-12">
			                                ...
			                                <input class="inputModal" type="text" name="edit-start-time" id="edit-start-time" />
			                            </div>
			                        </div>
			                        ...
			                        <div class="row">
			                            <div class="col-xs-12">
			                                ...
			                                <input class="inputModal" type="text" name="edit-end-time" id="edit-end-time" />
			                            </div>
			                        </div>
	    ...
	    <script src="/resource/api/fullCalendar_v3.9.0/vendor/js/bootstrap-datetimepicker.min.js"></script>
	    ...
	    <script src="/resource/api/fullCalendar_v3.9.0/js/editEvent.js"></script>
	    <script src="/resource/api/fullCalendar_v3.9.0/js/etcSetting.js"></script>
